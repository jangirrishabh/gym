...
class Gen3DiagonalFoldEnv(gen3_env.Gen3Env, utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        gen3_env.Gen3Env.__init__(
            ...
            obj_range=0.15, target_range=0.01, distance_threshold=0.05, cloth_length=11, behavior=behaviors[0],
